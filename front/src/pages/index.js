        ...
        <div className="mx-auto max-w-6xl sm:px-6 lg:px-8">
          ...
          <div className="mt-8 overflow-hidden bg-white shadow sm:rounded-lg dark:bg-gray-800">
            <div className="grid grid-cols-1 md:grid-cols-2">
              ...
              <div className="border-t border-gray-200 p-6 md:border-l md:border-t-0 dark:border-gray-700">
                <div className="flex items-center">
                  <svg
                    fill="none"
                    stroke="currentColor"
              ...
              <div className="border-t border-gray-200 p-6 md:border-l dark:border-gray-700">
                <div className="flex items-center">
                  <svg
                    fill="none"
                    stroke="currentColor"
          ...
          <div className="mt-4 flex justify-center sm:items-center sm:justify-between">
            <div className="text-center text-sm text-gray-500 sm:text-left">
              <div className="flex items-center">
                <svg
                  ...
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                  className="-mt-px size-5 text-gray-400"
                >
                ...
                <svg
                  ...
                  strokeWidth="2"
                  viewBox="0 0 24 24"
                  className="-mt-px ml-4 size-5 text-gray-400"
                >
            ...
            <div className="ml-4 text-center text-sm text-gray-500 sm:ml-0 sm:text-right">
